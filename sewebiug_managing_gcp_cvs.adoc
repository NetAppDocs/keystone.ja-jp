...
* Cloud Volumes Service for GCPがBlueXPで既に構成されていることをサポートチームが確認します。詳細については、を参照してください https://["Cloud Volumes Service for Google Cloud をセットアップします"]。
